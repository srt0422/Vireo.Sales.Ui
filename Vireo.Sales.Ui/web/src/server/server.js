...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_nodemailer__ = __webpack_require__(13);
...
},
{
    ...
    (err) => {
        server.views({
            engines: { html: __webpack_require__(18) },
            path: "views"
        });
...
server.route({
    ...
    handler: {
        async await(request, reply) {
            let customers = await __WEBPACK_IMPORTED_MODULE_2__data_collections__["d" /* customersCollection */].getAll();
...
const { lstatSync, readdirSync } = __webpack_require__(19)
const { join } = __webpack_require__(20)
...
server.route({
    ...
    handler: {
        async await(request, reply) {
            ...
            await __WEBPACK_IMPORTED_MODULE_2__data_collections__["c" /* contactsCollection */].save(request.payload);
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_0__customersCollection__["a"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__contactsCollection__ = __webpack_require__(12);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_3__contactsCollection__["a"]; });
﻿
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_0__collection__["a" /* default */]("contacts"));
